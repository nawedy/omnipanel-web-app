...
const AIChatInputCard: React.FC = () => {
  return (
    <StyledWrapper>
        ...
        <div className="container-chat-options">
          <div className="chat">
            <div className="chat-bot">
              <textarea id="ai_chat_input" name="ciphy" placeholder="Imagine Something...✦˚" defaultValue="" />
            </div>
...
const StyledWrapper = styled.div`
  ...
  .container_ai_chat_input .chat .chat-bot textarea {
  ...
  .container_ai_chat_input .chat .options .btn-submit {
    ...
    border-radius: 10px;
    box-shadow: inset 0 4px 2px rgba(0, 0,0.3), inset 0 -4px 2px rgba(255,255,255,0.2);
    cursor: pointer;
    border: none;
    outline: none;
    & .icon {
    ...
    &:focus .svg-icon {
      transform: scale(1.2) rotate(45deg) translate(-2px, 1px);
      color: #ffffff;
    }
...
export default AIChatInputCard;