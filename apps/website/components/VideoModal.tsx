            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl sm:p-6">
                <div className="absolute right-0 top-0 pr-4 pt-4">
                  <button
                    type="button"
                    className="rounded-md bg-white dark:bg-gray-900 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                    onClick={onClose}
                  >
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          See how OmniPanel transforms your AI workflow in just 3 minutes.
                        </p>
                      </div>
                    </div>
                  </div>
